...
I hold an M.Sc. in **Intelligent Field Robotics** ([Erasmus Mundus](https://en.wikipedia.org/wiki/Erasmus_Mundus), Universitat de Girona / University of Zagreb). A good part of my work has been in **space systems** — including ESA projects, ISS-payload work, and the HUNOR / Argonaut program — where reliability and tight resource budgets shape every design decision. I currently act as **Systems Engineer** on an **ESA ISS-payload project (Phase B)**, and I worked as an **AI researcher** on the **HUNOR / Argonaut** space-health program.
